<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="W028.aspx.cs" Inherits="CustomizeRule.QCRule.W028" %>
                    ...
                    <table style="width: 100%;">
                         <tr>
                            <td align="center">
                                ...
                                <CimesUI:CimesButton ID="btnReject" runat="server" CssClass="CSOKButton"
                                        Text="<%$ Resources:Auto|RuleFace, Reject %>" OnClick="btnReject_Click"></CimesUI:CimesButton>
                            </td>
                        </tr>
                    </table>
                </div>
