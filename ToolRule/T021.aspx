<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="T021.aspx.cs" Inherits="CustomizeRule.ToolRule.T021" %>
                                        ...
                                        <td style="width: 98%; vertical-align: top;">--%>
                                            <div style="width: 800px; overflow: auto; height: 400px; margin-left: auto; margin-right: auto;">
                                                <CimesUI:CimesGridView id="gvQuery" runat="server" autogeneratecolumns="false" width="100%">
                                                    <columns>
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:Auto|RuleFace, SplitSelect %>" HeaderStyle-Width="10%" HeaderStyle-Wrap="false">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="ckbSelect" runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField HeaderText="<%$ Resources:Auto|RuleFace, ToolParts %>" DataField="ToolName" ItemStyle-Width="50%" ItemStyle-HorizontalAlign="Center" />
                                                        <asp:BoundField HeaderText="<%$ Resources:Auto|RuleFace, ToolTypes %>" DataField="ToolType" ItemStyle-Width="50%" ItemStyle-HorizontalAlign="Center"/>
                                                    </columns>
