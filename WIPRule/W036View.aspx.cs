...
{
    public partial class W036View : CimesRuleBasePage
    {
        ...
        private void RrintToPDF()
        {
            ...
            // 匯出檔名的設定
            string sReportFileName = @"\rpt\W036_rpt.rpt";
            ...
            string sExportFileName = Server.MapPath("../../") + @"PDF\W036_rpt" + reportID + ".pdf";
            string strPath = sMapPath + sReportFileName;
            string ReportPath = "http://" + sHost + sApplicationPath + "/PDF/W036_rpt" + reportID + ".pdf";

            DataSet dsLot = (DataSet)Session["W036View"];
