<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="W025.aspx.cs" Inherits="CustomizeRule.WIPRule.W025" %>
                        ...
                        <td>
                            <fieldset class="CSFieldset">
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td class="CSTDMust">
                                            <asp:Label ID="lblBoxNo" runat="server" Text="<%$ Resources:Auto|RuleFace, Box %>"></asp:Label>
                                        </td>
                                        <td>
