...
{
    public partial class W035View : CimesRuleBasePage
    {
        ...
        private void RrintToPDF()
        {
            ...
            // 匯出檔名的設定
            string sReportFileName = @"\rpt\W035_rpt.rpt";
            ...
            string sExportFileName = Server.MapPath("../../") + @"PDF\W035_rpt" + reportID + ".pdf";
            string strPath = sMapPath + sReportFileName;
            string ReportPath = "http://" + sHost + sApplicationPath + "/PDF/W035_rpt" + reportID + ".pdf";

            DataSet dsLot = (DataSet)Session["W035View"];
