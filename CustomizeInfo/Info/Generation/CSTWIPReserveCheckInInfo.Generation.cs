...
{
    /// <summary>
    ///  (Mapping CST_WIP_RESERVE_CHECKIN_INFO Table)
    /// </summary>
    [Serializable]
    public partial class CSTWIPReserveCheckInInfo : InfoBase 
    {
        private static readonly CSTWIPReserveCheckInInfo s_ProxyInfo;
        
        
        
        private CST_WIP_RESERVE_CHECKIN_INFO_Row m_StrongTypeRow { get { return (CST_WIP_RESERVE_CHECKIN_INFO_Row)GetSchemaRow(); } }
        ...
        #region Properties
        /// <summary>
        /// WIP_RESERVE_CHECKIN_INFO_SID
        /// </summary>
        protected override DataColumn IDColumn { get { return CST_WIP_RESERVE_CHECKIN_INFO.WIP_RESERVE_CHECKIN_INFO_SID; } }
        ...
        #region Ctor(...)
        static CSTWIPReserveCheckInInfo()
        {
            CSTWIPReserveCheckInInfo info = new CSTWIPReserveCheckInInfo();
            info.SetSchemaRow(CST_WIP_RESERVE_CHECKIN_INFO.NewRow());
            s_ProxyInfo = info;
        }
        
        /// <summary>
        /// 建構一空的 CSTWIPReserveCheckInInfo 物件, 此 Ctor 是供 Generator 使用, 請勿直接呼叫.
        /// </summary>
        public CSTWIPReserveCheckInInfo() { }
        
        /// <summary>
        /// 建構一新的 CSTWIPReserveCheckInInfo object，由指定的 CST_WIP_RESERVE_CHECKIN_INFO_Row 為 Raw Row。
        /// 此 Ctor 只供內部程式呼叫使用, 不為 public ctor.
        /// </summary>
        [Obsolete("已被 InfoBase.Create method 取代")]
        protected internal CSTWIPReserveCheckInInfo(CST_WIP_RESERVE_CHECKIN_INFO_Row row) : base(row) { }
        #endregion
