...
{
  /// <summary>
  /// CST_EQP_DEVICE_RELEASE table schema 機台料號刀具驗證成功資訊
  /// </summary>
  public class CST_EQP_DEVICE_RELEASE : DBTableSchemaBase
  {
    /// <summary>
    /// 該類別的唯一實體, 供 Runtime 才能決定類別情況下使用
    /// </summary>
    public static CST_EQP_DEVICE_RELEASE Singleton = new CST_EQP_DEVICE_RELEASE();
    ...
    /// </summary>
    public static DataColumn EQP_DEVICE_RELEASE_SID { get { return Singleton.Columns["EQP_DEVICE_RELEASE_SID"]; } } 
    /// <summary>
    ...
    private CST_EQP_DEVICE_RELEASE()
    {
        // 不須鎖定 m_DataTable, 因為在這個時點, 不可能 有其他地方 同時存取 m_DataTable       
        
        base.m_DataTable.TableName = "CST_EQP_DEVICE_RELEASE";
        ...
        public static CST_EQP_DEVICE_RELEASE_Row NewRow() { return (CST_EQP_DEVICE_RELEASE_Row)Singleton.CreateRow(); }
        ...
        {
            CST_EQP_DEVICE_RELEASE_Row[] rowArray = new CST_EQP_DEVICE_RELEASE_Row[length];
            for (int i = 0; i < rowArray.Length; ++i)
            {
                rowArray[i] = (CST_EQP_DEVICE_RELEASE_Row)CreateRow();
            }
            return rowArray;
        }
        ...
        public override DBTableRowBase CreateRow() 
        {
            ...
            return new CST_EQP_DEVICE_RELEASE_Row(row);
        }
        ...
        {
            return this.GetOneRow<CST_EQP_DEVICE_RELEASE_Row>(sqlAgent);
        }
        ...
        public static CST_EQP_DEVICE_RELEASE_Row[] SelectRows()
        {
            return Singleton.GetRows<CST_EQP_DEVICE_RELEASE_Row>(SelectStar.Singleton, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_EQP_DEVICE_RELEASE_Row[] SelectRows(DataColumn[] cols)
        {
            return Singleton.GetRows<CST_EQP_DEVICE_RELEASE_Row>(cols, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_EQP_DEVICE_RELEASE_Row[] SelectRows(SqlAgent sql) { return Singleton.GetRows<CST_EQP_DEVICE_RELEASE_Row>(sql, "", null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_EQP_DEVICE_RELEASE_Row[] SelectRows(SqlAgent sql, string rowFilter) { return Singleton.GetRows<CST_EQP_DEVICE_RELEASE_Row>(sql, rowFilter, null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_EQP_DEVICE_RELEASE_Row[] SelectRows(SqlAgent sql, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_EQP_DEVICE_RELEASE_Row>(sql, "", dataAgent); }
        ...
        /// <param name="dataAgent">協助查詢的物件</param>
        /// <returns>Row Array</returns>
        public static CST_EQP_DEVICE_RELEASE_Row[] SelectRows(SqlAgent sql, string rowFilter, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_EQP_DEVICE_RELEASE_Row>(sql, rowFilter, dataAgent); }
