...
{
  /// <summary>
  /// CST_TOOL_REPAIR table schema 維修回廠資訊
  /// </summary>
  public class CST_TOOL_REPAIR : DBTableSchemaBase
  {
    /// <summary>
    /// 該類別的唯一實體, 供 Runtime 才能決定類別情況下使用
    /// </summary>
    public static CST_TOOL_REPAIR Singleton = new CST_TOOL_REPAIR();
    ...
    /// </summary>
    public static DataColumn TOOL_REPAIR_SID { get { return Singleton.Columns["TOOL_REPAIR_SID"]; } } 
    /// <summary>
    ...
    /// </summary>
    public static DataColumn REASON_CATEGORY { get { return Singleton.Columns["REASON_CATEGORY"]; } } 
    /// <summary>
    ...
    /// </summary>
    public static DataColumn ESTIMATE_DATE_OF_RETURN { get { return Singleton.Columns["ESTIMATE_DATE_OF_RETURN"]; } } 
    /// <summary>
    /// 送修人員 資料型態:NVARCHAR2(100) 是否允許Null:Y 
    /// </summary>
    public static DataColumn REPAIR_USER { get { return Singleton.Columns["REPAIR_USER"]; } } 
    /// <summary>
    /// 送修日 資料型態:NVARCHAR2(100) 是否允許Null:Y 
    /// </summary>
    public static DataColumn REPAIR_TIME { get { return Singleton.Columns["REPAIR_TIME"]; } } 
    /// <summary>
    /// 實際回廠日 資料型態:NVARCHAR2(100) 是否允許Null:Y 
    /// </summary>
    public static DataColumn ACTUAL_DATE_OF_RETURN { get { return Singleton.Columns["ACTUAL_DATE_OF_RETURN"]; } } 
    /// <summary>
    ...
    private CST_TOOL_REPAIR()
    {
        // 不須鎖定 m_DataTable, 因為在這個時點, 不可能 有其他地方 同時存取 m_DataTable       
        
        base.m_DataTable.TableName = "CST_TOOL_REPAIR";
        ...
        public static CST_TOOL_REPAIR_Row NewRow() { return (CST_TOOL_REPAIR_Row)Singleton.CreateRow(); }
        ...
        {
            CST_TOOL_REPAIR_Row[] rowArray = new CST_TOOL_REPAIR_Row[length];
            for (int i = 0; i < rowArray.Length; ++i)
            {
                rowArray[i] = (CST_TOOL_REPAIR_Row)CreateRow();
            }
            return rowArray;
        }
        ...
        public override DBTableRowBase CreateRow() 
        {
            ...
            return new CST_TOOL_REPAIR_Row(row);
        }
        ...
        {
            return this.GetOneRow<CST_TOOL_REPAIR_Row>(sqlAgent);
        }
        ...
        public static CST_TOOL_REPAIR_Row[] SelectRows()
        {
            return Singleton.GetRows<CST_TOOL_REPAIR_Row>(SelectStar.Singleton, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPAIR_Row[] SelectRows(DataColumn[] cols)
        {
            return Singleton.GetRows<CST_TOOL_REPAIR_Row>(cols, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPAIR_Row[] SelectRows(SqlAgent sql) { return Singleton.GetRows<CST_TOOL_REPAIR_Row>(sql, "", null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPAIR_Row[] SelectRows(SqlAgent sql, string rowFilter) { return Singleton.GetRows<CST_TOOL_REPAIR_Row>(sql, rowFilter, null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPAIR_Row[] SelectRows(SqlAgent sql, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_TOOL_REPAIR_Row>(sql, "", dataAgent); }
        ...
        /// <param name="dataAgent">協助查詢的物件</param>
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPAIR_Row[] SelectRows(SqlAgent sql, string rowFilter, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_TOOL_REPAIR_Row>(sql, rowFilter, dataAgent); }
