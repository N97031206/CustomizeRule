...
{
    /// <summary>
    /// CST_TOOL_USELOG table schema 刀具使用紀錄
    /// </summary>
    public class CST_TOOL_USELOG : DBTableSchemaBase
    {
        /// <summary>
        /// 該類別的唯一實體, 供 Runtime 才能決定類別情況下使用
        /// </summary>
        public static CST_TOOL_USELOG Singleton = new CST_TOOL_USELOG();
        ...
        /// </summary>
        public static DataColumn TOOL_USELOG_SID { get { return Singleton.Columns["TOOL_USELOG_SID"]; } }
        /// <summary>
        ...
        /// <summary>
        /// 操作時間 資料型態:NVARCHAR2(100) 是否允許Null:Y 
        /// </summary>
        ...
        private CST_TOOL_USELOG()
        {
            // 不須鎖定 m_DataTable, 因為在這個時點, 不可能 有其他地方 同時存取 m_DataTable       

            base.m_DataTable.TableName = "CST_TOOL_USELOG";
        ...
        public static CST_TOOL_USELOG_Row NewRow() { return (CST_TOOL_USELOG_Row)Singleton.CreateRow(); }
        ...
        {
            CST_TOOL_USELOG_Row[] rowArray = new CST_TOOL_USELOG_Row[length];
            for (int i = 0; i < rowArray.Length; ++i)
            {
                rowArray[i] = (CST_TOOL_USELOG_Row)CreateRow();
            }
            return rowArray;
        }
        ...
        public override DBTableRowBase CreateRow()
        {
            ...
            return new CST_TOOL_USELOG_Row(row);
        }
        ...
        {
            return this.GetOneRow<CST_TOOL_USELOG_Row>(sqlAgent);
        }
        ...
        public static CST_TOOL_USELOG_Row[] SelectRows()
        {
            return Singleton.GetRows<CST_TOOL_USELOG_Row>(SelectStar.Singleton, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_USELOG_Row[] SelectRows(DataColumn[] cols)
        {
            return Singleton.GetRows<CST_TOOL_USELOG_Row>(cols, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_USELOG_Row[] SelectRows(SqlAgent sql) { return Singleton.GetRows<CST_TOOL_USELOG_Row>(sql, "", null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_USELOG_Row[] SelectRows(SqlAgent sql, string rowFilter) { return Singleton.GetRows<CST_TOOL_USELOG_Row>(sql, rowFilter, null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_USELOG_Row[] SelectRows(SqlAgent sql, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_TOOL_USELOG_Row>(sql, "", dataAgent); }
        ...
        /// <param name="dataAgent">協助查詢的物件</param>
        /// <returns>Row Array</returns>
        public static CST_TOOL_USELOG_Row[] SelectRows(SqlAgent sql, string rowFilter, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_TOOL_USELOG_Row>(sql, rowFilter, dataAgent); }
