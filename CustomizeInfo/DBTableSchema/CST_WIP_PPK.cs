...
{
  /// <summary>
  /// CST_WIP_PPK table schema 
  /// </summary>
  public class CST_WIP_PPK : DBTableSchemaBase
  {
    /// <summary>
    /// 該類別的唯一實體, 供 Runtime 才能決定類別情況下使用
    /// </summary>
    public static CST_WIP_PPK Singleton = new CST_WIP_PPK();
    ...
    /// </summary>
    public static DataColumn WIP_PPK_SID { get { return Singleton.Columns["WIP_PPK_SID"]; } } 
    /// <summary>
    ...
    /// </summary>
    public static DataColumn PPKCOUNT { get { return Singleton.Columns["PPKCOUNT"]; } } 
    ...
    private CST_WIP_PPK()
    {
        ...
        base.m_DataTable.TableName = "CST_WIP_PPK";
        ...
        public static CST_WIP_PPK_Row NewRow() { return (CST_WIP_PPK_Row)Singleton.CreateRow(); }
        ...
        {
            CST_WIP_PPK_Row[] rowArray = new CST_WIP_PPK_Row[length];
            for (int i = 0; i < rowArray.Length; ++i)
            {
                rowArray[i] = (CST_WIP_PPK_Row)CreateRow();
            }
            return rowArray;
        }
        ...
        public override DBTableRowBase CreateRow() 
        {
            ...
            return new CST_WIP_PPK_Row(row);
        }
        ...
        {
            return this.GetOneRow<CST_WIP_PPK_Row>(sqlAgent);
        }
        ...
        public static CST_WIP_PPK_Row[] SelectRows()
        {
            return Singleton.GetRows<CST_WIP_PPK_Row>(SelectStar.Singleton, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_WIP_PPK_Row[] SelectRows(DataColumn[] cols)
        {
            return Singleton.GetRows<CST_WIP_PPK_Row>(cols, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_WIP_PPK_Row[] SelectRows(SqlAgent sql) { return Singleton.GetRows<CST_WIP_PPK_Row>(sql, "", null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_WIP_PPK_Row[] SelectRows(SqlAgent sql, string rowFilter) { return Singleton.GetRows<CST_WIP_PPK_Row>(sql, rowFilter, null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_WIP_PPK_Row[] SelectRows(SqlAgent sql, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_WIP_PPK_Row>(sql, "", dataAgent); }
        ...
        /// <param name="dataAgent">協助查詢的物件</param>
        /// <returns>Row Array</returns>
        public static CST_WIP_PPK_Row[] SelectRows(SqlAgent sql, string rowFilter, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_WIP_PPK_Row>(sql, rowFilter, dataAgent); }
