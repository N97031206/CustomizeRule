...
{
  /// <summary>
  /// CST_PRC_LINE table schema 線別工位設定主檔
  /// </summary>
  public class CST_PRC_LINE : DBTableSchemaBase
  {
    /// <summary>
    /// 該類別的唯一實體, 供 Runtime 才能決定類別情況下使用
    /// </summary>
    public static CST_PRC_LINE Singleton = new CST_PRC_LINE();
    ...
    private CST_PRC_LINE()
    {
        // 不須鎖定 m_DataTable, 因為在這個時點, 不可能 有其他地方 同時存取 m_DataTable       
        
        base.m_DataTable.TableName = "CST_PRC_LINE";
        ...
        public static CST_PRC_LINE_Row NewRow() { return (CST_PRC_LINE_Row)Singleton.CreateRow(); }
        ...
        {
            CST_PRC_LINE_Row[] rowArray = new CST_PRC_LINE_Row[length];
            for (int i = 0; i < rowArray.Length; ++i)
            {
                rowArray[i] = (CST_PRC_LINE_Row)CreateRow();
            }
            return rowArray;
        }
        ...
        public override DBTableRowBase CreateRow() 
        {
            ...
            return new CST_PRC_LINE_Row(row);
        }
        ...
        {
            return this.GetOneRow<CST_PRC_LINE_Row>(sqlAgent);
        }
        ...
        public static CST_PRC_LINE_Row[] SelectRows()
        {
            return Singleton.GetRows<CST_PRC_LINE_Row>(SelectStar.Singleton, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_PRC_LINE_Row[] SelectRows(DataColumn[] cols)
        {
            return Singleton.GetRows<CST_PRC_LINE_Row>(cols, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_PRC_LINE_Row[] SelectRows(SqlAgent sql) { return Singleton.GetRows<CST_PRC_LINE_Row>(sql, "", null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_PRC_LINE_Row[] SelectRows(SqlAgent sql, string rowFilter) { return Singleton.GetRows<CST_PRC_LINE_Row>(sql, rowFilter, null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_PRC_LINE_Row[] SelectRows(SqlAgent sql, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_PRC_LINE_Row>(sql, "", dataAgent); }
        ...
        /// <param name="dataAgent">協助查詢的物件</param>
        /// <returns>Row Array</returns>
        public static CST_PRC_LINE_Row[] SelectRows(SqlAgent sql, string rowFilter, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_PRC_LINE_Row>(sql, rowFilter, dataAgent); }
