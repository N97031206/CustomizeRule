...
{
  /// <summary>
  /// CST_TOOL_REPORT table schema 刀具檢驗報告資訊表
  /// </summary>
  public class CST_TOOL_REPORT : DBTableSchemaBase
  {
    /// <summary>
    /// 該類別的唯一實體, 供 Runtime 才能決定類別情況下使用
    /// </summary>
    public static CST_TOOL_REPORT Singleton = new CST_TOOL_REPORT();
    ...
    private CST_TOOL_REPORT()
    {
        // 不須鎖定 m_DataTable, 因為在這個時點, 不可能 有其他地方 同時存取 m_DataTable       
        
        base.m_DataTable.TableName = "CST_TOOL_REPORT";
        ...
        public static CST_TOOL_REPORT_Row NewRow() { return (CST_TOOL_REPORT_Row)Singleton.CreateRow(); }
        ...
        {
            CST_TOOL_REPORT_Row[] rowArray = new CST_TOOL_REPORT_Row[length];
            for (int i = 0; i < rowArray.Length; ++i)
            {
                rowArray[i] = (CST_TOOL_REPORT_Row)CreateRow();
            }
            return rowArray;
        }
        ...
        public override DBTableRowBase CreateRow() 
        {
            ...
            return new CST_TOOL_REPORT_Row(row);
        }
        ...
        {
            return this.GetOneRow<CST_TOOL_REPORT_Row>(sqlAgent);
        }
        ...
        public static CST_TOOL_REPORT_Row[] SelectRows()
        {
            return Singleton.GetRows<CST_TOOL_REPORT_Row>(SelectStar.Singleton, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPORT_Row[] SelectRows(DataColumn[] cols)
        {
            return Singleton.GetRows<CST_TOOL_REPORT_Row>(cols, null, null);
        }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPORT_Row[] SelectRows(SqlAgent sql) { return Singleton.GetRows<CST_TOOL_REPORT_Row>(sql, "", null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPORT_Row[] SelectRows(SqlAgent sql, string rowFilter) { return Singleton.GetRows<CST_TOOL_REPORT_Row>(sql, rowFilter, null); }
        ...
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPORT_Row[] SelectRows(SqlAgent sql, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_TOOL_REPORT_Row>(sql, "", dataAgent); }
        ...
        /// <param name="dataAgent">協助查詢的物件</param>
        /// <returns>Row Array</returns>
        public static CST_TOOL_REPORT_Row[] SelectRows(SqlAgent sql, string rowFilter, CustomDataAgent dataAgent) { return Singleton.GetRows<CST_TOOL_REPORT_Row>(sql, rowFilter, dataAgent); }
