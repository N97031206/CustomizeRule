...
{
    /// <summary>
    /// CST_TOOL_DEVICE_DETAIL_Row, 刀具驗證設定明細表
    /// </summary>
    [Serializable]
    public class CST_TOOL_DEVICE_DETAIL_Row : DBTableRowBase
    {            
        /// <summary>
        /// 取得該 Row 是屬於 CST_TOOL_DEVICE_DETAIL Table, 傳回代表該 Table Schema 的唯一實體
        /// </summary>
        public override DBTableSchemaBase TableSchema
        {
            get { return CST_TOOL_DEVICE_DETAIL.Singleton; }
        }
    
        #region Ctor()
        /// <summary>
        /// 建構一個空的 CST_TOOL_DEVICE_DETAIL_Row 物件.
        /// 此 Ctor 僅供 Cimes 內部 Generator 使用, 若要取得一 Row 實體, 請使用 Schema.NewRow()
        /// </summary>
        public CST_TOOL_DEVICE_DETAIL_Row() : base() {  }

        /// <summary>
        /// 以原生 DataRow 建構一個 CST_TOOL_DEVICE_DETAIL_Row 物件
        /// </summary>
        /// <param name="row">原生 DataRow</param>
        public CST_TOOL_DEVICE_DETAIL_Row(DataRow row) : base(row) {  }
        ...
        protected CST_TOOL_DEVICE_DETAIL_Row(SerializationInfo si, StreamingContext context) : base(si, context) {  }
        #endregion
    ...
    public String OPERATION { 
      ...
      set { this["OPERATION"] = string.IsNullOrEmpty(value) ? DBNull.Value : (object) value; } 
        ...
        public new CST_TOOL_DEVICE_DETAIL_Row DeepCopy()
        {
            return (CST_TOOL_DEVICE_DETAIL_Row) base.DeepCopy();
        }
    }
}
