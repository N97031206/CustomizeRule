...
{
    /// <summary>
    /// CST_WIP_FQC_DEFECT_Row, FQC不良紀錄
    /// </summary>
    [Serializable]
    public class CST_WIP_FQC_DEFECT_Row : DBTableRowBase
    {            
        /// <summary>
        /// 取得該 Row 是屬於 CST_WIP_FQC_DEFECT Table, 傳回代表該 Table Schema 的唯一實體
        /// </summary>
        public override DBTableSchemaBase TableSchema
        {
            get { return CST_WIP_FQC_DEFECT.Singleton; }
        }
    
        #region Ctor()
        /// <summary>
        /// 建構一個空的 CST_WIP_FQC_DEFECT_Row 物件.
        /// 此 Ctor 僅供 Cimes 內部 Generator 使用, 若要取得一 Row 實體, 請使用 Schema.NewRow()
        /// </summary>
        public CST_WIP_FQC_DEFECT_Row() : base() {  }

        /// <summary>
        /// 以原生 DataRow 建構一個 CST_WIP_FQC_DEFECT_Row 物件
        /// </summary>
        /// <param name="row">原生 DataRow</param>
        public CST_WIP_FQC_DEFECT_Row(DataRow row) : base(row) {  }
        ...
        protected CST_WIP_FQC_DEFECT_Row(SerializationInfo si, StreamingContext context) : base(si, context) {  }
        #endregion
    ...
    public String WIP_FQC_DEFECT_SID { 
      get { return (this["WIP_FQC_DEFECT_SID"] is DBNull) ? string.Empty : (String) this["WIP_FQC_DEFECT_SID"]; } 
      set { this["WIP_FQC_DEFECT_SID"] = string.IsNullOrEmpty(value) ? DBNull.Value : (object) value; } 
    } 
    ...
    public String UPDATETIME { 
      ...
      set { this["UPDATETIME"] = string.IsNullOrEmpty(value) ? DBNull.Value : (object) value; } 
        ...
        public new CST_WIP_FQC_DEFECT_Row DeepCopy()
        {
            return (CST_WIP_FQC_DEFECT_Row) base.DeepCopy();
        }
    }
}
