...
{
    /// <summary>
    /// CST_TOOL_REPORT_LOG_Row, 刀具檢驗報告資訊紀錄表
    /// </summary>
    [Serializable]
    public class CST_TOOL_REPORT_LOG_Row : DBTableRowBase
    {            
        /// <summary>
        /// 取得該 Row 是屬於 CST_TOOL_REPORT_LOG Table, 傳回代表該 Table Schema 的唯一實體
        /// </summary>
        public override DBTableSchemaBase TableSchema
        {
            get { return CST_TOOL_REPORT_LOG.Singleton; }
        }
    
        #region Ctor()
        /// <summary>
        /// 建構一個空的 CST_TOOL_REPORT_LOG_Row 物件.
        /// 此 Ctor 僅供 Cimes 內部 Generator 使用, 若要取得一 Row 實體, 請使用 Schema.NewRow()
        /// </summary>
        public CST_TOOL_REPORT_LOG_Row() : base() {  }

        /// <summary>
        /// 以原生 DataRow 建構一個 CST_TOOL_REPORT_LOG_Row 物件
        /// </summary>
        /// <param name="row">原生 DataRow</param>
        public CST_TOOL_REPORT_LOG_Row(DataRow row) : base(row) {  }
        ...
        protected CST_TOOL_REPORT_LOG_Row(SerializationInfo si, StreamingContext context) : base(si, context) {  }
        #endregion

                    /// <summary>
    /// 刀具檢驗報告資訊紀錄表 資料型態:NVARCHAR2(100) 是否允許Null:Y 
    /// </summary>
    public String TOOL_REPORT_LOG_SID { 
      get { return (this["TOOL_REPORT_LOG_SID"] is DBNull) ? string.Empty : (String) this["TOOL_REPORT_LOG_SID"]; } 
      set { this["TOOL_REPORT_LOG_SID"] = string.IsNullOrEmpty(value) ? DBNull.Value : (object) value; } 
    } 
    ...
    public String APPLICATIONNAME { 
      ...
      set { this["APPLICATIONNAME"] = string.IsNullOrEmpty(value) ? DBNull.Value : (object) value; } 
        ...
        public new CST_TOOL_REPORT_LOG_Row DeepCopy()
        {
            return (CST_TOOL_REPORT_LOG_Row) base.DeepCopy();
        }
    }
}
