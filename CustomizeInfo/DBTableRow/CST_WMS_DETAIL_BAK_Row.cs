...
{
    /// <summary>
    /// CST_WMS_DETAIL_BAK_Row, 
    /// </summary>
    [Serializable]
    public class CST_WMS_DETAIL_BAK_Row : DBTableRowBase
    {            
        /// <summary>
        /// 取得該 Row 是屬於 CST_WMS_DETAIL_BAK Table, 傳回代表該 Table Schema 的唯一實體
        /// </summary>
        public override DBTableSchemaBase TableSchema
        {
            get { return CST_WMS_DETAIL_BAK.Singleton; }
        }
    
        #region Ctor()
        /// <summary>
        /// 建構一個空的 CST_WMS_DETAIL_BAK_Row 物件.
        /// 此 Ctor 僅供 Cimes 內部 Generator 使用, 若要取得一 Row 實體, 請使用 Schema.NewRow()
        /// </summary>
        public CST_WMS_DETAIL_BAK_Row() : base() {  }

        /// <summary>
        /// 以原生 DataRow 建構一個 CST_WMS_DETAIL_BAK_Row 物件
        /// </summary>
        /// <param name="row">原生 DataRow</param>
        public CST_WMS_DETAIL_BAK_Row(DataRow row) : base(row) {  }
        ...
        protected CST_WMS_DETAIL_BAK_Row(SerializationInfo si, StreamingContext context) : base(si, context) {  }
        #endregion
    ...
    public String WMS_DETAIL_BAK_SID { 
      get { return (this["WMS_DETAIL_BAK_SID"] is DBNull) ? string.Empty : (String) this["WMS_DETAIL_BAK_SID"]; } 
      set { this["WMS_DETAIL_BAK_SID"] = string.IsNullOrEmpty(value) ? DBNull.Value : (object) value; } 
    } 
    ...
    public String LINKSID { 
      ...
      set { this["LINKSID"] = string.IsNullOrEmpty(value) ? DBNull.Value : (object) value; } 
        ...
        public new CST_WMS_DETAIL_BAK_Row DeepCopy()
        {
            return (CST_WMS_DETAIL_BAK_Row) base.DeepCopy();
        }
    }
}
