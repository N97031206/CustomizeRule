    ...
    <form id="T009Set" method="post" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <table style="width: 497px; margin-left: auto; margin-right: auto;">
                    <tr>
                        <td align="center">
                            <div style="overflow: auto; margin-left: auto; margin-right: auto; width: 100%; height: 200px;">
                                <CimesUI:CimesGridView ID="gvQuery" runat="server" Width="100%" AutoGenerateColumns="false" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ToolType" HeaderText="<%$ Resources:Auto|RuleFace, ToolTypes %>" HeaderStyle-Width="40%"/>
                                        <asp:BoundField DataField="Quantity" HeaderText="<%$ Resources:Auto|RuleFace, Quantity %>" HeaderStyle-Width="40%"/>
                                    </Columns>
