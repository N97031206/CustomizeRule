            ...
            <ContentTemplate>
                ...
                <div style="overflow: auto; margin-left: auto; margin-right: auto; width: 500px; height: 300px;">
                    <CimesUI:CimesGridView ID="gvToolReport" runat="server" Width="98%" AutoGenerateColumns="false" 
                        OnRowDataBound="gvToolReport_RowDataBound" >
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:Auto|RuleFace, UpdateTime %>" HeaderStyle-Width="40%" HeaderStyle-Wrap="false">
                                <ItemTemplate>
